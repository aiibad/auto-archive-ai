...
**Auto-Archive** is a full-stack document intelligence platform that transforms disorganized files into a structured, searchable digital vault. By leveraging LLMs (Large Language Models), the application automatically classifies, summarizes, and extracts metadata from user-uploaded images, Url Links and PDFs.
